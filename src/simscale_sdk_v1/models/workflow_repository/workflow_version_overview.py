...
class WorkflowVersionOverview(SimScaleModel):
    """Workflow version overview data structure. Holds high-level information but skips details (for example data mapping and configuration) to keep the response size reasonably small."""
