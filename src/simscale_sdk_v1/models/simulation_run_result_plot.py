...
class SimulationRunResultPlot(SimScaleModel):
    type_: str = Field(validation_alias="type", serialization_alias="type", default="PLOT")
    ...
    quantity: SimulationRunResultQuantity | None = Field(default=None)
