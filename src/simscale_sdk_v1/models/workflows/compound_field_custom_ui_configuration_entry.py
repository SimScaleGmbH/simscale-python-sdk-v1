...
class CompoundFieldCustomUiConfigurationEntry(SimScaleModel):
    ...
    custom_ui_configuration_value: Any | None = Field(
        validation_alias="customUiConfigurationValue",
        serialization_alias="customUiConfigurationValue",
        default=None,
