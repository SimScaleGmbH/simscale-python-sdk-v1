...
from simscale_sdk_v1.models.workflows.dimensional_profiles_object_dimension import DimensionalProfilesObjectDimension


class DimensionalField(SimScaleModel):
    ...
    dimensional_profiles: DimensionalProfilesObjectDimension | None = Field(
        validation_alias="dimensionalProfiles", serialization_alias="dimensionalProfiles", default=None
    )
    quantity_class: str | None = Field(
        validation_alias="quantityClass",
        serialization_alias="quantityClass",
        default="",
