...
_VALUE_LIST_SCALING_POINT_VALUE_MODEL_VARIANTS: dict[str, type] = {
...
ValueListScalingPointValueModel = Annotated[
    Union[
        ConstantValueList,
    ...
    BeforeValidator(
        partial(
            ...
            variants=_VALUE_LIST_SCALING_POINT_VALUE_MODEL_VARIANTS,
        )
    ),
]
