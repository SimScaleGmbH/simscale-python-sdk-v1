...
class MeasurementUnitField(SimScaleModel):
    ...
    unit_profiles: UnitProfilesDimension | None = Field(
        validation_alias="unitProfiles", serialization_alias="unitProfiles", default=None
    )
