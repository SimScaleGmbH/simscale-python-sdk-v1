...
class EnumField(SimScaleModel):
    ...
    enum_value_type: Literal["STRING", "INTEGER"] | None = Field(
        validation_alias="enumValueType",
        serialization_alias="enumValueType",
        default="",
    ...
    value_docs: dict[str, EnumValueDoc] | None = Field(
        validation_alias="valueDocs", serialization_alias="valueDocs", default=None
    )
    value_labels: dict[str, EnumValueLabel] | None = Field(
        validation_alias="valueLabels", serialization_alias="valueLabels", default=None
    )
