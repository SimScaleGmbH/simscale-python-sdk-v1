...
_VALUE_LIST_TIME_BY_ARCH_VALUE_MODEL_VARIANTS: dict[str, type] = {
...
ValueListTimeByArchValueModel = Annotated[
    Union[
        ConstantValueList,
    ...
    BeforeValidator(
        partial(
            ...
            variants=_VALUE_LIST_TIME_BY_ARCH_VALUE_MODEL_VARIANTS,
        )
    ),
]
