...
class StateScreenshotOutputSettings(SimScaleModel):
    ...
    frame_index: int = Field(
        validation_alias="frameIndex", serialization_alias="frameIndex", description="The frame index from the state."
    )
