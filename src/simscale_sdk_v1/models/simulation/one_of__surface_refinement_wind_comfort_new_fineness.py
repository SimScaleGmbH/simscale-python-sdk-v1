...
_ONE_OF__SURFACE_REFINEMENT_WIND_COMFORT_NEW_FINENESS_VARIANTS: dict[str, type] = {
...
OneOf_SurfaceRefinementWindComfortNewFineness = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__SURFACE_REFINEMENT_WIND_COMFORT_NEW_FINENESS_VARIANTS,
        )
    ),
]
