...
_ONE_OF__SPATIAL_DISCRETIZATION_SCHEMES_TURBULENT_KINETIC_ENERGY_VARIANTS: dict[str, type] = {
...
OneOf_SpatialDiscretizationSchemesTurbulentKineticEnergy = Annotated[
    Union[FirstOrderUpwindSpatialScheme, SecondOrderUpwindSpatialScheme, CentralDifferenceSpatialScheme],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SPATIAL_DISCRETIZATION_SCHEMES_TURBULENT_KINETIC_ENERGY_VARIANTS,
        )
    ),
]
