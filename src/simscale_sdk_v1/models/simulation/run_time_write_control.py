...
class RunTimeWriteControl(SimScaleModel):
    ...
    type_: str = Field(
        ...
        default="RUNTIME",
        description="This option controls how the simulation results are written and how frequently.  Schema name: RunTimeWriteControl",
    )
