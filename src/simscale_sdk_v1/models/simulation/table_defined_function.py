...
class TableDefinedFunction(SimScaleModel):
    type_: str = Field(
    ...
    interpolation: Literal["LINEAR", "LOGARITHMIC"] | None = Field(default="LINEAR")
    left_extrapolation: Literal["CONSTANT", "LINEAR", "NONE"] | None = Field(
        validation_alias="leftExtrapolation", serialization_alias="leftExtrapolation", default="LINEAR"
    )
    right_extrapolation: Literal["CONSTANT", "LINEAR", "NONE"] | None = Field(
        validation_alias="rightExtrapolation", serialization_alias="rightExtrapolation", default="LINEAR"
    )
