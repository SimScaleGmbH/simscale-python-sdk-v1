...
# Please choose a boundary condition for modified pressure (p_rgh). Learn more.
_ONE_OF__CUSTOM_FLUID_BC_PRESSURE_RGH_VARIANTS: dict[str, type] = {
...
OneOf_CustomFluidBCPressureRgh = Annotated[
    Union[
        SymmetryPBC,
        FanPBC,
        FixedFluxPBC,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__CUSTOM_FLUID_BC_PRESSURE_RGH_VARIANTS,
        )
    ),
]
