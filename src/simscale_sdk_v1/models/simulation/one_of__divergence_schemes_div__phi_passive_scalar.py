...
_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHI_PASSIVE_SCALAR_VARIANTS: dict[str, type] = {
...
OneOf_DivergenceSchemesDiv_Phi_passiveScalar = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHI_PASSIVE_SCALAR_VARIANTS,
        )
    ),
]
