...
_ONE_OF__GRADIENT_SCHEMES_GRAD_ENTHALPY_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesGrad_enthalpy = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_GRAD_ENTHALPY_VARIANTS,
        )
    ),
]
