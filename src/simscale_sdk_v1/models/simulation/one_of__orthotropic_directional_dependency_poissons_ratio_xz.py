...
OneOf_OrthotropicDirectionalDependencyPoissonsRatioXZ = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__ORTHOTROPIC_DIRECTIONAL_DEPENDENCY_POISSONS_RATIO_XZ_VARIANTS,
        )
    ),
]
