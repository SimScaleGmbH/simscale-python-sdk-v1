...
_ONE_OF__COUPLED_CONJUGATE_HEAT_TRANSFER_MATERIALS_FLUIDS_VARIANTS: dict[str, type] = {
    "INCOMPRESSIBLE": IncompressibleMaterial,
    "COMPRESSIBLE": FluidCompressibleMaterial,
}

OneOf_CoupledConjugateHeatTransferMaterialsFluids = Annotated[
    Union[IncompressibleMaterial, FluidCompressibleMaterial],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__COUPLED_CONJUGATE_HEAT_TRANSFER_MATERIALS_FLUIDS_VARIANTS,
        )
    ),
]
