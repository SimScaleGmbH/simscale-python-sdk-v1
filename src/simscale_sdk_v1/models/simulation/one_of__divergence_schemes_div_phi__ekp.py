...
_ONE_OF__DIVERGENCE_SCHEMES_DIV_PHI__EKP_VARIANTS: dict[str, type] = {
...
OneOf_DivergenceSchemesDiv_phi_Ekp = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DIVERGENCE_SCHEMES_DIV_PHI__EKP_VARIANTS,
        )
    ),
]
