...
_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHI_EPSILON_DISSIPATION_RATE_VARIANTS: dict[str, type] = {
...
OneOf_DivergenceSchemesDiv_Phi_epsilonDissipationRate = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHI_EPSILON_DISSIPATION_RATE_VARIANTS,
        )
    ),
]
