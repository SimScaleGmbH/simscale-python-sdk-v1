...
_ONE_OF__DIMENSIONAL_FUNCTION__TIME_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_DimensionalFunction_TimeValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DIMENSIONAL_FUNCTION__TIME_VALUE_VARIANTS,
        )
    ),
]
