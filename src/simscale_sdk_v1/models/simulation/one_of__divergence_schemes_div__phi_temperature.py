...
_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHI_TEMPERATURE_VARIANTS: dict[str, type] = {
...
OneOf_DivergenceSchemesDiv_Phi_temperature = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHI_TEMPERATURE_VARIANTS,
        )
    ),
]
