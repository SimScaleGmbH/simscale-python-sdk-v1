...
_ONE_OF__MANUAL_SIMERICS_MESH_SETTINGS_REFINEMENTS_VARIANTS: dict[str, type] = {
    "REGION_REFINEMENT_SIMERICS": RegionRefinementSimerics,
    "SURFACE_REFINEMENT_SIMERICS": SurfaceRefinementSimerics,
}

OneOf_ManualSimericsMeshSettingsRefinements = Annotated[
    Union[RegionRefinementSimerics, SurfaceRefinementSimerics],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__MANUAL_SIMERICS_MESH_SETTINGS_REFINEMENTS_VARIANTS,
        )
    ),
]
