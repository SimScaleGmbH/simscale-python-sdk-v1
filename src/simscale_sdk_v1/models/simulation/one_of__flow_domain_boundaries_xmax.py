...
_ONE_OF__FLOW_DOMAIN_BOUNDARIES_XMAX_VARIANTS: dict[str, type] = {
...
OneOf_FlowDomainBoundariesXMAX = Annotated[
    Union[VelocityInletBC, PressureOutletBC, WallBC, PeriodicBC, AtmosphericBoundaryLayerInletBC],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLOW_DOMAIN_BOUNDARIES_XMAX_VARIANTS,
        )
    ),
]
