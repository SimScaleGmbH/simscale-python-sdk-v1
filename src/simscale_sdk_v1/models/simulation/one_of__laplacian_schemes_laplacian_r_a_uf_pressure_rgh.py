...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_R_A_UF_PRESSURE_RGH_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_rAUf_pressureRgh = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_R_A_UF_PRESSURE_RGH_VARIANTS,
        )
    ),
]
