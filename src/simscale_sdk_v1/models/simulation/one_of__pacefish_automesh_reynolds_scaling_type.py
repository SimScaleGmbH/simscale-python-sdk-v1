...
_ONE_OF__PACEFISH_AUTOMESH_REYNOLDS_SCALING_TYPE_VARIANTS: dict[str, type] = {
    "AUTOMATIC_REYNOLDS_SCALING": AutomaticReynoldsScaling,
    "MANUAL_REYNOLDS_SCALING": ManualReynoldsScaling,
}

OneOf_PacefishAutomeshReynoldsScalingType = Annotated[
    Union[AutomaticReynoldsScaling, ManualReynoldsScaling],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__PACEFISH_AUTOMESH_REYNOLDS_SCALING_TYPE_VARIANTS,
        )
    ),
]
