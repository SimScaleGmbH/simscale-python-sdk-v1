...
_ONE_OF__INLET_OUTLET_RHBC_HUMIDITY_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_InletOutletRHBCHumidityValue = Annotated[
    Union[RelativeHumidityValue, SpecificHumidityValue, AbsoluteHumidityValue],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__INLET_OUTLET_RHBC_HUMIDITY_VALUE_VARIANTS,
        )
    ),
]
