...
_ONE_OF__STATIC_ANALYSIS_CONNECTION_GROUPS_VARIANTS: dict[str, type] = {
    "CONTACT": Contact,
    "PHYSICAL_CONTACT_V36": PhysicalContact,
}

OneOf_StaticAnalysisConnectionGroups = Annotated[
    Union[Contact, PhysicalContact],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__STATIC_ANALYSIS_CONNECTION_GROUPS_VARIANTS,
        )
    ),
]
