...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_DT_PASSIVE_SCALAR_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_DT_passiveScalar = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_DT_PASSIVE_SCALAR_VARIANTS,
        )
    ),
]
