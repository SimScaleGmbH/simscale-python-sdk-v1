...
_ONE_OF__LAPLACIAN_SCHEMES_FOR_DEFAULT_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesForDefault = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_FOR_DEFAULT_VARIANTS,
        )
    ),
]
