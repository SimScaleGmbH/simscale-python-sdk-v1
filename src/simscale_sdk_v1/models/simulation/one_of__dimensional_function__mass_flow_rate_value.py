...
_ONE_OF__DIMENSIONAL_FUNCTION__MASS_FLOW_RATE_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_DimensionalFunction_MassFlowRateValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DIMENSIONAL_FUNCTION__MASS_FLOW_RATE_VALUE_VARIANTS,
        )
    ),
]
