...
_ONE_OF__FLUID_SOLVERS_DENSITY_FINAL_SOLVER_VARIANTS: dict[str, type] = {
    "GAMG": GAMGSolver,
    "PCG": PCGSolver,
    "SMOOTH": SmoothSolver,
}

OneOf_FluidSolversDensityFinalSolver = Annotated[
    Union[GAMGSolver, PCGSolver, SmoothSolver],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLUID_SOLVERS_DENSITY_FINAL_SOLVER_VARIANTS,
        )
    ),
]
