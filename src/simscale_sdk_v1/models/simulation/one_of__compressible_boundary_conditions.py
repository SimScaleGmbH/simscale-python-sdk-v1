...
_ONE_OF__COMPRESSIBLE_BOUNDARY_CONDITIONS_VARIANTS: dict[str, type] = {
...
OneOf_CompressibleBoundaryConditions = Annotated[
    Union[
        VelocityInletBC,
        VelocityOutletBC,
        PressureInletBC,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__COMPRESSIBLE_BOUNDARY_CONDITIONS_VARIANTS,
        )
    ),
]
