...
_ONE_OF__SURFACE_NORMAL_GRADIENT_SCHEMES_SURFACE_NORMAL_GRADIENT_RHOK_VARIANTS: dict[str, type] = {
...
OneOf_SurfaceNormalGradientSchemesSurfaceNormalGradient_rhok = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__SURFACE_NORMAL_GRADIENT_SCHEMES_SURFACE_NORMAL_GRADIENT_RHOK_VARIANTS,
        )
    ),
]
