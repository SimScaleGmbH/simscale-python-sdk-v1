...
_ONE_OF__PRESCRIBED_OPTIONAL_FUNCTION_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_PrescribedOptionalFunctionValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__PRESCRIBED_OPTIONAL_FUNCTION_VALUE_VARIANTS,
        )
    ),
]
