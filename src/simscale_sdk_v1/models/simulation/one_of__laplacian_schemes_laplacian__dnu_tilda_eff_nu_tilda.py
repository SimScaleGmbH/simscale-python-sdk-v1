...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__DNU_TILDA_EFF_NU_TILDA_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_DnuTildaEff_nuTilda = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__DNU_TILDA_EFF_NU_TILDA_VARIANTS,
        )
    ),
]
