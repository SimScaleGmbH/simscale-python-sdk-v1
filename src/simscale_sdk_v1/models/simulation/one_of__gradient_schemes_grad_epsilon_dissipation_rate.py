...
_ONE_OF__GRADIENT_SCHEMES_GRAD_EPSILON_DISSIPATION_RATE_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesGrad_epsilonDissipationRate = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_GRAD_EPSILON_DISSIPATION_RATE_VARIANTS,
        )
    ),
]
