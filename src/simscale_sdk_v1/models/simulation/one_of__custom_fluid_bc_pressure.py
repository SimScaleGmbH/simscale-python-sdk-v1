...
_ONE_OF__CUSTOM_FLUID_BC_PRESSURE_VARIANTS: dict[str, type] = {
    "ADVECTIVE": AdvectivePBC,
...
OneOf_CustomFluidBCPressure = Annotated[
    Union[
        AdvectivePBC,
        SymmetryPBC,
        FanPBC,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__CUSTOM_FLUID_BC_PRESSURE_VARIANTS,
        )
    ),
]
