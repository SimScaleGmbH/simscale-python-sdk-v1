...
_ONE_OF__MARC_RESULT_CONTROL_VOLUME_CALCULATION_VARIANTS: dict[str, type] = {
...
OneOf_MarcResultControlVolumeCalculation = Annotated[
    Union[
        MarcMinMaxFieldsCalculationResultControlItem,
        MarcAverageFieldsCalculationResultControlItem,
        MarcSumFieldsCalculationResultControlItem,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__MARC_RESULT_CONTROL_VOLUME_CALCULATION_VARIANTS,
        )
    ),
]
