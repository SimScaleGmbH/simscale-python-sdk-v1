...
_ONE_OF__GRADIENT_SCHEMES_FOR_DEFAULT_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesForDefault = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_FOR_DEFAULT_VARIANTS,
        )
    ),
]
