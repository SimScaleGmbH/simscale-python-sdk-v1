...
_ONE_OF__GRADIENT_SCHEMES_GRAD_PRESSURE_RGH_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesGrad_pressureRgh = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_GRAD_PRESSURE_RGH_VARIANTS,
        )
    ),
]
