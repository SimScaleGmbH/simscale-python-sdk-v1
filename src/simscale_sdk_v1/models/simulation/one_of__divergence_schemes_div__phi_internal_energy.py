...
_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHI_INTERNAL_ENERGY_VARIANTS: dict[str, type] = {
...
OneOf_DivergenceSchemesDiv_Phi_internalEnergy = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHI_INTERNAL_ENERGY_VARIANTS,
        )
    ),
]
