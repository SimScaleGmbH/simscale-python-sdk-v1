...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__NU_EFF_VELOCITY_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_NuEff_velocity = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__NU_EFF_VELOCITY_VARIANTS,
        )
    ),
]
