...
_ONE_OF__PRESSURE_INLET_BC_RADIATIVE_INTENSITY_RAY_VARIANTS: dict[str, type] = {
...
OneOf_PressureInletBCRadiativeIntensityRay = Annotated[
    Union[GreybodyDiffusiveRayBC, OpenBoundaryRayBC, SemiOpenBoundaryRayBC],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__PRESSURE_INLET_BC_RADIATIVE_INTENSITY_RAY_VARIANTS,
        )
    ),
]
