...
_ONE_OF__VELOCITY_INLET_BC_TEMPERATURE_VARIANTS: dict[str, type] = {
    "FIXED_VALUE": FixedValueTBC,
    "TOTAL_TEMPERATURE": TotalTBC,
}

OneOf_VelocityInletBCTemperature = Annotated[
    Union[FixedValueTBC, TotalTBC],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__VELOCITY_INLET_BC_TEMPERATURE_VARIANTS,
        )
    ),
]
