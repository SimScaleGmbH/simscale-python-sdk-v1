...
_ONE_OF__SURFACE_NORMAL_GRADIENT_SCHEMES_FOR_DEFAULT_VARIANTS: dict[str, type] = {
...
OneOf_SurfaceNormalGradientSchemesForDefault = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__SURFACE_NORMAL_GRADIENT_SCHEMES_FOR_DEFAULT_VARIANTS,
        )
    ),
]
