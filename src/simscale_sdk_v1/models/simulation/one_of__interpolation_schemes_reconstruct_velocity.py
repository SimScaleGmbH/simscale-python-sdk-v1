...
_ONE_OF__INTERPOLATION_SCHEMES_RECONSTRUCT_VELOCITY_VARIANTS: dict[str, type] = {
    "CUBIC": CubicInterpolationScheme,
    "LINEAR": LinearInterpolationScheme,
}

OneOf_InterpolationSchemesReconstruct_velocity = Annotated[
    Union[CubicInterpolationScheme, LinearInterpolationScheme],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__INTERPOLATION_SCHEMES_RECONSTRUCT_VELOCITY_VARIANTS,
        )
    ),
]
