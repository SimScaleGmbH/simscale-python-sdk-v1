...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__DK_EFF_TURBULENT_KINETIC_ENERGY_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_DkEff_turbulentKineticEnergy = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__DK_EFF_TURBULENT_KINETIC_ENERGY_VARIANTS,
        )
    ),
]
