...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_ALPHA_ENTHALPY_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_alpha_enthalpy = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_ALPHA_ENTHALPY_VARIANTS,
        )
    ),
]
