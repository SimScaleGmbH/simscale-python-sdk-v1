...
_ONE_OF__DYNAMIC_ANALYSIS_BOUNDARY_CONDITIONS_VARIANTS: dict[str, type] = {
...
OneOf_DynamicAnalysisBoundaryConditions = Annotated[
    Union[
        BoltPreloadBC,
        ElasticSupportBC,
        FixedSupportBC,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DYNAMIC_ANALYSIS_BOUNDARY_CONDITIONS_VARIANTS,
        )
    ),
]
