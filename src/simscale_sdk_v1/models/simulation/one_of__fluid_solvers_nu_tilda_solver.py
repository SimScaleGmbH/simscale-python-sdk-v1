...
_ONE_OF__FLUID_SOLVERS_NU_TILDA_SOLVER_VARIANTS: dict[str, type] = {
    "PBICG": PBICGSolver,
    "SMOOTH": SmoothSolver,
}

OneOf_FluidSolversNuTildaSolver = Annotated[
    Union[PBICGSolver, SmoothSolver],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLUID_SOLVERS_NU_TILDA_SOLVER_VARIANTS,
        )
    ),
]
