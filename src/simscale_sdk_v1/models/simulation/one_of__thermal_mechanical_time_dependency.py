...
_ONE_OF__THERMAL_MECHANICAL_TIME_DEPENDENCY_VARIANTS: dict[str, type] = {
    "TRANSIENT": TransientTimeDependency,
    "STATIONARY": StationaryTimeDependency,
}

OneOf_ThermalMechanicalTimeDependency = Annotated[
    Union[TransientTimeDependency, StationaryTimeDependency],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__THERMAL_MECHANICAL_TIME_DEPENDENCY_VARIANTS,
        )
    ),
]
