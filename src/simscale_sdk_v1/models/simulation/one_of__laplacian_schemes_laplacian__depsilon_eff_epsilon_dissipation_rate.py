...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__DEPSILON_EFF_EPSILON_DISSIPATION_RATE_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_DepsilonEff_epsilonDissipationRate = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__DEPSILON_EFF_EPSILON_DISSIPATION_RATE_VARIANTS,
        )
    ),
]
