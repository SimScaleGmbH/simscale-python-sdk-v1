...
_ONE_OF__INTERPOLATION_SCHEMES_INTERPOLATE_THERMO_RHO__CP_VARIANTS: dict[str, type] = {
    "CUBIC": CubicInterpolationScheme,
    "LINEAR": LinearInterpolationScheme,
}

OneOf_InterpolationSchemesInterpolate_thermo_rho_Cp = Annotated[
    Union[CubicInterpolationScheme, LinearInterpolationScheme],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__INTERPOLATION_SCHEMES_INTERPOLATE_THERMO_RHO__CP_VARIANTS,
        )
    ),
]
