...
_ONE_OF__FIXED_COEFF_MEDIUM_ORIENTATION_VARIANTS: dict[str, type] = {
    "CARTESIAN": CartesianOrientation,
    "CUSTOM": CustomOrientation,
}

OneOf_FixedCoeffMediumOrientation = Annotated[
    Union[CartesianOrientation, CustomOrientation],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FIXED_COEFF_MEDIUM_ORIENTATION_VARIANTS,
        )
    ),
]
