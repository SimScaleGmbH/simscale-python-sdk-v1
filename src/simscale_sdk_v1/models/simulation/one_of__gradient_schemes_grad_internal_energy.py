...
_ONE_OF__GRADIENT_SCHEMES_GRAD_INTERNAL_ENERGY_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesGrad_internalEnergy = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_GRAD_INTERNAL_ENERGY_VARIANTS,
        )
    ),
]
