...
_ONE_OF__FREQUENCY_ANALYSIS_CONNECTORS_VARIANTS: dict[str, type] = {
    "PIN_CONNECTOR": PinConnector,
    "BOLT_CONNECTOR": BoltConnector,
}

OneOf_FrequencyAnalysisConnectors = Annotated[
    Union[PinConnector, BoltConnector],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FREQUENCY_ANALYSIS_CONNECTORS_VARIANTS,
        )
    ),
]
