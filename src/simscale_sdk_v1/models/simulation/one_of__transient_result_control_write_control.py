...
_ONE_OF__TRANSIENT_RESULT_CONTROL_WRITE_CONTROL_VARIANTS: dict[str, type] = {
...
OneOf_TransientResultControlWriteControl = Annotated[
    Union[HighResolution, ModerateResolution, CoarseResolution, CustomResolution],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__TRANSIENT_RESULT_CONTROL_WRITE_CONTROL_VARIANTS,
        )
    ),
]
