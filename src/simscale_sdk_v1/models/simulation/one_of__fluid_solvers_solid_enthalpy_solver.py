...
_ONE_OF__FLUID_SOLVERS_SOLID_ENTHALPY_SOLVER_VARIANTS: dict[str, type] = {
    "GAMG": GAMGSolver,
    "PCG": PCGSolver,
    "SMOOTH": SmoothSolver,
}

OneOf_FluidSolversSolidEnthalpySolver = Annotated[
    Union[GAMGSolver, PCGSolver, SmoothSolver],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLUID_SOLVERS_SOLID_ENTHALPY_SOLVER_VARIANTS,
        )
    ),
]
