...
_ONE_OF__DIMENSIONAL_FUNCTION__MAGNETIC_FLUX_DENSITY_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_DimensionalFunction_MagneticFluxDensityValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DIMENSIONAL_FUNCTION__MAGNETIC_FLUX_DENSITY_VALUE_VARIANTS,
        )
    ),
]
