...
_ONE_OF__FLOW_DOMAIN_BOUNDARIES_YMAX_VARIANTS: dict[str, type] = {
...
OneOf_FlowDomainBoundariesYMAX = Annotated[
    Union[VelocityInletBC, PressureOutletBC, WallBC, PeriodicBC, AtmosphericBoundaryLayerInletBC],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLOW_DOMAIN_BOUNDARIES_YMAX_VARIANTS,
        )
    ),
]
