...
_ONE_OF__GRADIENT_SCHEMES_GRAD_VELOCITY_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesGrad_velocity = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_GRAD_VELOCITY_VARIANTS,
        )
    ),
]
