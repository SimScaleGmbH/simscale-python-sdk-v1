...
_ONE_OF__CUSTOM_FLUID_BC_GAUGE_PRESSURE_VARIANTS: dict[str, type] = {
...
OneOf_CustomFluidBCGaugePressure = Annotated[
    Union[
        SymmetryPBC,
        FanPBC,
        FixedGradientPBC,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__CUSTOM_FLUID_BC_GAUGE_PRESSURE_VARIANTS,
        )
    ),
]
