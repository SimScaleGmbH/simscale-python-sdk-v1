...
_ONE_OF__PROBE_POINTS_RESULT_CONTROL_WRITE_CONTROL_VARIANTS: dict[str, type] = {
...
OneOf_ProbePointsResultControlWriteControl = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__PROBE_POINTS_RESULT_CONTROL_WRITE_CONTROL_VARIANTS,
        )
    ),
]
