...
_ONE_OF__CONVECTIVE_HEAT_TRANSFER_BOUNDARY_CONDITIONS_VARIANTS: dict[str, type] = {
...
OneOf_ConvectiveHeatTransferBoundaryConditions = Annotated[
    Union[
        VelocityInletBC,
        VelocityOutletBC,
        PressureInletBC,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__CONVECTIVE_HEAT_TRANSFER_BOUNDARY_CONDITIONS_VARIANTS,
        )
    ),
]
