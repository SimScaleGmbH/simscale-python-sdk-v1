...
_ONE_OF__FRICTION_CONTACT_FICTITIOUS_CLEARANCE_VARIANTS: dict[str, type] = {
    "NO_FICTITIOUS_CLEARANCE": NoFictitiousClearance,
    "WITH_FICTITIOUS_CLEARANCE": WithFictitiousClearance,
}

OneOf_FrictionContactFictitiousClearance = Annotated[
    Union[NoFictitiousClearance, WithFictitiousClearance],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FRICTION_CONTACT_FICTITIOUS_CLEARANCE_VARIANTS,
        )
    ),
]
