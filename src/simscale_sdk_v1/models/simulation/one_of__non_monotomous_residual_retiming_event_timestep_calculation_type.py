...
_ONE_OF__NON_MONOTOMOUS_RESIDUAL_RETIMING_EVENT_TIMESTEP_CALCULATION_TYPE_VARIANTS: dict[str, type] = {
    "NEWTON_ITERATION": NewtonIterationTimestepCalculationType,
    "MANUAL": ManualTimestepCalculationType,
}

OneOf_NonMonotomousResidualRetimingEventTimestepCalculationType = Annotated[
    Union[NewtonIterationTimestepCalculationType, ManualTimestepCalculationType],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__NON_MONOTOMOUS_RESIDUAL_RETIMING_EVENT_TIMESTEP_CALCULATION_TYPE_VARIANTS,
        )
    ),
]
