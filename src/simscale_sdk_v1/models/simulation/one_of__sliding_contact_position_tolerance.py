...
_ONE_OF__SLIDING_CONTACT_POSITION_TOLERANCE_VARIANTS: dict[str, type] = {
    "SET_VALUE": SetValuePositionTolerance,
    "OFF": OffPositionTolerance,
}

OneOf_SlidingContactPositionTolerance = Annotated[
    Union[SetValuePositionTolerance, OffPositionTolerance],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SLIDING_CONTACT_POSITION_TOLERANCE_VARIANTS,
        )
    ),
]
