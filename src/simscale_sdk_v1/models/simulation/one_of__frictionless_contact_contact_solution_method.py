...
_ONE_OF__FRICTIONLESS_CONTACT_CONTACT_SOLUTION_METHOD_VARIANTS: dict[str, type] = {
    "AUGMENTED_LAGRANGE": AugmentedLagrangeMethod,
    "PENALTY_METHOD": PenaltyMethod,
}

OneOf_FrictionlessContactContactSolutionMethod = Annotated[
    Union[AugmentedLagrangeMethod, PenaltyMethod],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FRICTIONLESS_CONTACT_CONTACT_SOLUTION_METHOD_VARIANTS,
        )
    ),
]
