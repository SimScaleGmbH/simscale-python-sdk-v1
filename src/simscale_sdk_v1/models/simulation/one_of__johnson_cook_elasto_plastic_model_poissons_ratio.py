...
_ONE_OF__JOHNSON_COOK_ELASTO_PLASTIC_MODEL_POISSONS_RATIO_VARIANTS: dict[str, type] = {
...
OneOf_JohnsonCookElastoPlasticModelPoissonsRatio = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__JOHNSON_COOK_ELASTO_PLASTIC_MODEL_POISSONS_RATIO_VARIANTS,
        )
    ),
]
