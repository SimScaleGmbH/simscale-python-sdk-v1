...
_ONE_OF__SOLID_NUMERICS_THERMAL_LINE_SEARCH_VARIANTS: dict[str, type] = {
    "FALSE": FalseLineSearch,
    "TRUE": TrueLineSearch,
}

OneOf_SolidNumericsThermalLineSearch = Annotated[
    Union[FalseLineSearch, TrueLineSearch],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SOLID_NUMERICS_THERMAL_LINE_SEARCH_VARIANTS,
        )
    ),
]
