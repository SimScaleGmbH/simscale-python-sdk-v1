...
_ONE_OF__GRADIENT_SCHEMES_GRAD_RHOK_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesGrad_rhok = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_GRAD_RHOK_VARIANTS,
        )
    ),
]
