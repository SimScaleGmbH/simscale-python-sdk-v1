...
_ONE_OF__ISOTROPIC_DIRECTIONAL_DEPENDENCY_POISSONS_RATIO_VARIANTS: dict[str, type] = {
...
OneOf_IsotropicDirectionalDependencyPoissonsRatio = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__ISOTROPIC_DIRECTIONAL_DEPENDENCY_POISSONS_RATIO_VARIANTS,
        )
    ),
]
