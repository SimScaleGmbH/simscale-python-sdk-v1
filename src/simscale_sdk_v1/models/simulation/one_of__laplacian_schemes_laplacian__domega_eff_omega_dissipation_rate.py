...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__DOMEGA_EFF_OMEGA_DISSIPATION_RATE_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_DomegaEff_omegaDissipationRate = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN__DOMEGA_EFF_OMEGA_DISSIPATION_RATE_VARIANTS,
        )
    ),
]
