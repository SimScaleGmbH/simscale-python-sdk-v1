...
_ONE_OF__NEWTON_RESOLUTION_TYPE_JACOBIAN_MATRIX_VARIANTS: dict[str, type] = {
    "TANGENT": TangentJacobianMatrix,
    "ELASTIC": ElasticJacobianMatrix,
}

OneOf_NewtonResolutionTypeJacobianMatrix = Annotated[
    Union[TangentJacobianMatrix, ElasticJacobianMatrix],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__NEWTON_RESOLUTION_TYPE_JACOBIAN_MATRIX_VARIANTS,
        )
    ),
]
