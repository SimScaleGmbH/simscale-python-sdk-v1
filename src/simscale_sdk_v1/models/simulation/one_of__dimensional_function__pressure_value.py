...
_ONE_OF__DIMENSIONAL_FUNCTION__PRESSURE_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_DimensionalFunction_PressureValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DIMENSIONAL_FUNCTION__PRESSURE_VALUE_VARIANTS,
        )
    ),
]
