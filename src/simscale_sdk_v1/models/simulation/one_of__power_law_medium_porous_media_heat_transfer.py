...
_ONE_OF__POWER_LAW_MEDIUM_POROUS_MEDIA_HEAT_TRANSFER_VARIANTS: dict[str, type] = {
    "FLUID_ONLY_HEAT_TRANSFER": FluidOnlyHeatTransfer,
    "EFFECTIVE_CONDUCTIVITY_HEAT_TRANSFER": EffectiveConductivityHeatTransfer,
}

OneOf_PowerLawMediumPorousMediaHeatTransfer = Annotated[
    Union[FluidOnlyHeatTransfer, EffectiveConductivityHeatTransfer],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__POWER_LAW_MEDIUM_POROUS_MEDIA_HEAT_TRANSFER_VARIANTS,
        )
    ),
]
