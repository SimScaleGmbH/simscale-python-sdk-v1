...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_1_A_U_PRESSURE_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_1A_U_pressure = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_1_A_U_PRESSURE_VARIANTS,
        )
    ),
]
