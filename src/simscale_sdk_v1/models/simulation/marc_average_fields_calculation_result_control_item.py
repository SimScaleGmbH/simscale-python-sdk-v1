...
class MarcAverageFieldsCalculationResultControlItem(SimScaleModel):
    type_: str = Field(
    ...
    field_selection: OneOf_MarcAverageFieldsCalculationResultControlItemFieldSelection | None = Field(
