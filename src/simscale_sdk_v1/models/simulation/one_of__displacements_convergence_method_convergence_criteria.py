...
_ONE_OF__DISPLACEMENTS_CONVERGENCE_METHOD_CONVERGENCE_CRITERIA_VARIANTS: dict[str, type] = {
...
OneOf_DisplacementsConvergenceMethodConvergenceCriteria = Annotated[
    Union[RelativeConvergenceDisplacements, AbsoluteConvergenceDisplacements, AdaptiveConvergenceDisplacements],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DISPLACEMENTS_CONVERGENCE_METHOD_CONVERGENCE_CRITERIA_VARIANTS,
        )
    ),
]
