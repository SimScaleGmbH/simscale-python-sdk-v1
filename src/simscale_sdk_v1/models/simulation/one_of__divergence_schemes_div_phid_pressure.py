...
_ONE_OF__DIVERGENCE_SCHEMES_DIV_PHID_PRESSURE_VARIANTS: dict[str, type] = {
...
OneOf_DivergenceSchemesDiv_phid_pressure = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DIVERGENCE_SCHEMES_DIV_PHID_PRESSURE_VARIANTS,
        )
    ),
]
