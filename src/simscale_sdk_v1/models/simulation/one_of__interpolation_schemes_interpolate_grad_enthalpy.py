...
_ONE_OF__INTERPOLATION_SCHEMES_INTERPOLATE_GRAD_ENTHALPY_VARIANTS: dict[str, type] = {
    "CUBIC": CubicInterpolationScheme,
    "LINEAR": LinearInterpolationScheme,
}

OneOf_InterpolationSchemesInterpolate_grad_enthalpy = Annotated[
    Union[CubicInterpolationScheme, LinearInterpolationScheme],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__INTERPOLATION_SCHEMES_INTERPOLATE_GRAD_ENTHALPY_VARIANTS,
        )
    ),
]
