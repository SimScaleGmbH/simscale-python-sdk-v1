...
class HeatTransfer(SimScaleModel):
    type_: str = Field(
    ...
    time_dependency: OneOf_HeatTransferTimeDependency | None = Field(
    ...
    boundary_conditions: list[OneOf_HeatTransferBoundaryConditions] | None = Field(
