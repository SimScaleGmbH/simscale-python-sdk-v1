...
_ONE_OF__GRADIENT_SCHEMES_GRAD_NU_TILDA_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesGrad_nuTilda = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_GRAD_NU_TILDA_VARIANTS,
        )
    ),
]
