...
class CpuTimeWriteControl(SimScaleModel):
    ...
    type_: str = Field(
        ...
        default="CPU_TIME",
        description="This option controls how the simulation results are written and how frequently.  Schema name: CpuTimeWriteControl",
    )
