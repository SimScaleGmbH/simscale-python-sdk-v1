...
_ONE_OF__SOLID_NUMERICS_THERMAL_RESOLUTION_TYPE_VARIANTS: dict[str, type] = {
    "NEWTON": NewtonResolutionType,
    "NEWTON_KRYLOV": NewtonKrylovResolutionType,
}

OneOf_SolidNumericsThermalResolutionType = Annotated[
    Union[NewtonResolutionType, NewtonKrylovResolutionType],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SOLID_NUMERICS_THERMAL_RESOLUTION_TYPE_VARIANTS,
        )
    ),
]
