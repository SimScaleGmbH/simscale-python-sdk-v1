...
_ONE_OF__DIMENSIONAL_FUNCTION__ROTATION_SPEED_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_DimensionalFunction_RotationSpeedValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DIMENSIONAL_FUNCTION__ROTATION_SPEED_VALUE_VARIANTS,
        )
    ),
]
