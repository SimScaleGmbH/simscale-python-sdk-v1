...
_ONE_OF__DIMENSIONAL_FUNCTION__SPECIFIC_ENERGY_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_DimensionalFunction_SpecificEnergyValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DIMENSIONAL_FUNCTION__SPECIFIC_ENERGY_VALUE_VARIANTS,
        )
    ),
]
