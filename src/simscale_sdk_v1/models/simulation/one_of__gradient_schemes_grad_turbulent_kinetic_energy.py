...
_ONE_OF__GRADIENT_SCHEMES_GRAD_TURBULENT_KINETIC_ENERGY_VARIANTS: dict[str, type] = {
...
OneOf_GradientSchemesGrad_turbulentKineticEnergy = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__GRADIENT_SCHEMES_GRAD_TURBULENT_KINETIC_ENERGY_VARIANTS,
        )
    ),
]
