...
_ONE_OF__PRESSURE_OUTLET_BC_PHASE_FRACTIONS_V2_VARIANTS: dict[str, type] = {
    "OUTLET_BACK_FLOW_PF_VALUES": OutletBackFlowPFValues,
    "OUTLET_FLOW_DRIVEN_PF": OutletFlowDrivenPF,
}

OneOf_PressureOutletBCPhaseFractionsV2 = Annotated[
    Union[OutletBackFlowPFValues, OutletFlowDrivenPF],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__PRESSURE_OUTLET_BC_PHASE_FRACTIONS_V2_VARIANTS,
        )
    ),
]
