...
_ONE_OF__DIVERGENCE_SCHEMES_DIV_RHO_PHI_VELOCITY_VARIANTS: dict[str, type] = {
...
OneOf_DivergenceSchemesDiv_rhoPhi_velocity = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DIVERGENCE_SCHEMES_DIV_RHO_PHI_VELOCITY_VARIANTS,
        )
    ),
]
