...
_ONE_OF__FAN_BC_NET_RADIATIVE_HEAT_FLUX_VARIANTS: dict[str, type] = {
    "GREYBODY_DIFFUSIVE": GreybodyDiffusiveRSBC,
    "OPEN_WINDOW": OpenWindowRSBC,
}

OneOf_FanBCNetRadiativeHeatFlux = Annotated[
    Union[GreybodyDiffusiveRSBC, OpenWindowRSBC],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FAN_BC_NET_RADIATIVE_HEAT_FLUX_VARIANTS,
        )
    ),
]
