...
_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_DR_EFF_R_VARIANTS: dict[str, type] = {
...
OneOf_LaplacianSchemesLaplacian_DREff_R = Annotated[
    Union[
        GaussLinearCorrectedLaplacianScheme,
        GaussLinearLimitedCorrectedLaplacianScheme,
        GaussLinearUncorrectedLaplacianScheme,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__LAPLACIAN_SCHEMES_LAPLACIAN_DR_EFF_R_VARIANTS,
        )
    ),
]
