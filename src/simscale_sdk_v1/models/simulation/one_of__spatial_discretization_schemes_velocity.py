...
_ONE_OF__SPATIAL_DISCRETIZATION_SCHEMES_VELOCITY_VARIANTS: dict[str, type] = {
...
OneOf_SpatialDiscretizationSchemesVelocity = Annotated[
    Union[FirstOrderUpwindSpatialScheme, SecondOrderUpwindSpatialScheme, CentralDifferenceSpatialScheme],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SPATIAL_DISCRETIZATION_SCHEMES_VELOCITY_VARIANTS,
        )
    ),
]
