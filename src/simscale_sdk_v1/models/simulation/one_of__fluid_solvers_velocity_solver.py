...
_ONE_OF__FLUID_SOLVERS_VELOCITY_SOLVER_VARIANTS: dict[str, type] = {
    "PBICG": PBICGSolver,
    "PBICGStab": PBICGStabSolver,
    "SMOOTH": SmoothSolver,
}

OneOf_FluidSolversVelocitySolver = Annotated[
    Union[PBICGSolver, PBICGStabSolver, SmoothSolver],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLUID_SOLVERS_VELOCITY_SOLVER_VARIANTS,
        )
    ),
]
