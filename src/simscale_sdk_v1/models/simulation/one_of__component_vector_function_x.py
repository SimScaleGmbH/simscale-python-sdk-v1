...
_ONE_OF__COMPONENT_VECTOR_FUNCTION_X_VARIANTS: dict[str, type] = {
...
OneOf_ComponentVectorFunctionX = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__COMPONENT_VECTOR_FUNCTION_X_VARIANTS,
        )
    ),
]
