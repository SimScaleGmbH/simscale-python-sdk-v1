...
_ONE_OF__INTERPOLATION_SCHEMES_INTERPOLATE_VELOCITY0_VARIANTS: dict[str, type] = {
    "CUBIC": CubicInterpolationScheme,
    "LINEAR": LinearInterpolationScheme,
}

OneOf_InterpolationSchemesInterpolate_velocity0 = Annotated[
    Union[CubicInterpolationScheme, LinearInterpolationScheme],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__INTERPOLATION_SCHEMES_INTERPOLATE_VELOCITY0_VARIANTS,
        )
    ),
]
