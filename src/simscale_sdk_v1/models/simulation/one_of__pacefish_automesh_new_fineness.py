...
_ONE_OF__PACEFISH_AUTOMESH_NEW_FINENESS_VARIANTS: dict[str, type] = {
...
OneOf_PacefishAutomeshNewFineness = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__PACEFISH_AUTOMESH_NEW_FINENESS_VARIANTS,
        )
    ),
]
