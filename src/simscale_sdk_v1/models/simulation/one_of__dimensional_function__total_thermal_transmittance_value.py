...
_ONE_OF__DIMENSIONAL_FUNCTION__TOTAL_THERMAL_TRANSMITTANCE_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_DimensionalFunction_TotalThermalTransmittanceValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DIMENSIONAL_FUNCTION__TOTAL_THERMAL_TRANSMITTANCE_VALUE_VARIANTS,
        )
    ),
]
