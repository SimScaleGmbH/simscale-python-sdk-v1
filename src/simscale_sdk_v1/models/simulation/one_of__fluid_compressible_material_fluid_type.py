...
_ONE_OF__FLUID_COMPRESSIBLE_MATERIAL_FLUID_TYPE_VARIANTS: dict[str, type] = {
    "LIQUID": FluidTypeLiquid,
    "GAS": FluidTypeGas,
}

OneOf_FluidCompressibleMaterialFluidType = Annotated[
    Union[FluidTypeLiquid, FluidTypeGas],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLUID_COMPRESSIBLE_MATERIAL_FLUID_TYPE_VARIANTS,
        )
    ),
]
