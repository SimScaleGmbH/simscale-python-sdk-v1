...
_ONE_OF__DARCY_MEDIUM_POROUS_MATERIAL_TYPE_VARIANTS: dict[str, type] = {
    "HOMOGENEOUS": HomogeneousMaterialStructure,
    "DIRECTIONAL": DirectionalMaterialStructure,
}

OneOf_DarcyMediumPorousMaterialType = Annotated[
    Union[HomogeneousMaterialStructure, DirectionalMaterialStructure],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DARCY_MEDIUM_POROUS_MATERIAL_TYPE_VARIANTS,
        )
    ),
]
