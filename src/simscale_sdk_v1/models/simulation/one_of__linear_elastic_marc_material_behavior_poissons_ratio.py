...
_ONE_OF__LINEAR_ELASTIC_MARC_MATERIAL_BEHAVIOR_POISSONS_RATIO_VARIANTS: dict[str, type] = {
...
OneOf_LinearElasticMarcMaterialBehaviorPoissonsRatio = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__LINEAR_ELASTIC_MARC_MATERIAL_BEHAVIOR_POISSONS_RATIO_VARIANTS,
        )
    ),
]
