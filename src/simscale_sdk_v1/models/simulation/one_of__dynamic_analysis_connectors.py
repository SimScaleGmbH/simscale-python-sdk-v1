...
_ONE_OF__DYNAMIC_ANALYSIS_CONNECTORS_VARIANTS: dict[str, type] = {
    "PIN_CONNECTOR": PinConnector,
    "BOLT_CONNECTOR": BoltConnector,
}

OneOf_DynamicAnalysisConnectors = Annotated[
    Union[PinConnector, BoltConnector],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DYNAMIC_ANALYSIS_CONNECTORS_VARIANTS,
        )
    ),
]
