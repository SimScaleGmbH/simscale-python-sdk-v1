...
_ONE_OF__TEMPORAL_RESPONSE_RESULT_CONTROL_ITEM_FIELD_SELECTION_VARIANTS: dict[str, type] = {
...
OneOf_TemporalResponseResultControlItemFieldSelection = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__TEMPORAL_RESPONSE_RESULT_CONTROL_ITEM_FIELD_SELECTION_VARIANTS,
        )
    ),
]
