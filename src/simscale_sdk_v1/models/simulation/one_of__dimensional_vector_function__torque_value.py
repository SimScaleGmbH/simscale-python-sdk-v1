...
_ONE_OF__DIMENSIONAL_VECTOR_FUNCTION__TORQUE_VALUE_VARIANTS: dict[str, type] = {
    "COMPONENT": ComponentVectorFunction,
    "TABLE_DEFINED": TableDefinedVectorFunction,
}

OneOf_DimensionalVectorFunction_TorqueValue = Annotated[
    Union[ComponentVectorFunction, TableDefinedVectorFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DIMENSIONAL_VECTOR_FUNCTION__TORQUE_VALUE_VARIANTS,
        )
    ),
]
