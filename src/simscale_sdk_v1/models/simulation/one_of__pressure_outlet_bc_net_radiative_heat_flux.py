...
_ONE_OF__PRESSURE_OUTLET_BC_NET_RADIATIVE_HEAT_FLUX_VARIANTS: dict[str, type] = {
    "GREYBODY_DIFFUSIVE": GreybodyDiffusiveRSBC,
    "OPEN_WINDOW": OpenWindowRSBC,
}

OneOf_PressureOutletBCNetRadiativeHeatFlux = Annotated[
    Union[GreybodyDiffusiveRSBC, OpenWindowRSBC],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__PRESSURE_OUTLET_BC_NET_RADIATIVE_HEAT_FLUX_VARIANTS,
        )
    ),
]
