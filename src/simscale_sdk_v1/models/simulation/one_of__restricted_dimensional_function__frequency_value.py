...
_ONE_OF__RESTRICTED_DIMENSIONAL_FUNCTION__FREQUENCY_VALUE_VARIANTS: dict[str, type] = {
...
OneOf_RestrictedDimensionalFunction_FrequencyValue = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, RestrictedTableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__RESTRICTED_DIMENSIONAL_FUNCTION__FREQUENCY_VALUE_VARIANTS,
        )
    ),
]
