...
_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHIV_PRESSURE_VARIANTS: dict[str, type] = {
...
OneOf_DivergenceSchemesDiv_Phiv_pressure = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__DIVERGENCE_SCHEMES_DIV__PHIV_PRESSURE_VARIANTS,
        )
    ),
]
