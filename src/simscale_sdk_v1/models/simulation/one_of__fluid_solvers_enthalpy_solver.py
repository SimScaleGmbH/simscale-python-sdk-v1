...
_ONE_OF__FLUID_SOLVERS_ENTHALPY_SOLVER_VARIANTS: dict[str, type] = {
    "PBICG": PBICGSolver,
    "SMOOTH": SmoothSolver,
}

OneOf_FluidSolversEnthalpySolver = Annotated[
    Union[PBICGSolver, SmoothSolver],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLUID_SOLVERS_ENTHALPY_SOLVER_VARIANTS,
        )
    ),
]
