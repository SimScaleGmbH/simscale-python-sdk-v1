...
class RhoConstEquationOfState(SimScaleModel):
    ...
    type_: str = Field(
        ...
        default="RHO_CONST",
        description="The Equation of state describes the relation between density of a fluid and the fluid pressure and temperature. The available options are:Rho const: Fluid density is assumed constant.Incompressibel perfect gas: The fluid is assumed to be an 'Ideal Gas' that is incompressible by pressure. But, fluid density can change due to temperature.Perfect gas: Fluid is assumed to be an 'Ideal Gas' and obeys the 'Ideal Gas Law'.Perfect fluid: Fluid density can change due to pressure and temperature with respect to a base value.Adiabatic perfect fluid: The fluid is a perfect fluid which is adiabatic in nature. Learn more.  Schema name: RhoConstEquationOfState",
    )
    density: Dimensional_Density | None = Field(default=None)
    density_function: DimensionalFunction_Density | None = Field(
        validation_alias="densityFunction", serialization_alias="densityFunction", default=None
    )
