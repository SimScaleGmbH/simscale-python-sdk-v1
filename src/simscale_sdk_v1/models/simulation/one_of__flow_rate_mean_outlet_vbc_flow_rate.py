...
_ONE_OF__FLOW_RATE_MEAN_OUTLET_VBC_FLOW_RATE_VARIANTS: dict[str, type] = {
    "MASS": MassFlow,
    "VOLUMETRIC": VolumetricFlow,
}

OneOf_FlowRateMeanOutletVBCFlowRate = Annotated[
    Union[MassFlow, VolumetricFlow],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLOW_RATE_MEAN_OUTLET_VBC_FLOW_RATE_VARIANTS,
        )
    ),
]
