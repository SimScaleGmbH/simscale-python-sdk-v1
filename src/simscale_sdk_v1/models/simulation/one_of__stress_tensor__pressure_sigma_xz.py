...
_ONE_OF__STRESS_TENSOR__PRESSURE_SIGMA_XZ_VARIANTS: dict[str, type] = {
...
OneOf_StressTensor_PressureSigmaXZ = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__STRESS_TENSOR__PRESSURE_SIGMA_XZ_VARIANTS,
        )
    ),
]
