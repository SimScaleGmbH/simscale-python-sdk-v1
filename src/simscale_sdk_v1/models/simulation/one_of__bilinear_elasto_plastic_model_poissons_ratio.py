...
_ONE_OF__BILINEAR_ELASTO_PLASTIC_MODEL_POISSONS_RATIO_VARIANTS: dict[str, type] = {
...
OneOf_BilinearElastoPlasticModelPoissonsRatio = Annotated[
    Union[ConstantFunction, ExpressionFunction, PolynomialFunction, TableDefinedFunction],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__BILINEAR_ELASTO_PLASTIC_MODEL_POISSONS_RATIO_VARIANTS,
        )
    ),
]
