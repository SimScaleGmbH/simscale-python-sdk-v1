...
_ONE_OF__SPATIAL_DISCRETIZATION_SCHEMES_GAS_MIXTURE_TRANSPORT_VARIANTS: dict[str, type] = {
...
OneOf_SpatialDiscretizationSchemesGasMixtureTransport = Annotated[
    Union[FirstOrderUpwindSpatialScheme, SecondOrderUpwindSpatialScheme, CentralDifferenceSpatialScheme],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SPATIAL_DISCRETIZATION_SCHEMES_GAS_MIXTURE_TRANSPORT_VARIANTS,
        )
    ),
]
