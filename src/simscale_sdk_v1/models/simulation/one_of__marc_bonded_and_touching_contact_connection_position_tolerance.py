...
_ONE_OF__MARC_BONDED_AND_TOUCHING_CONTACT_CONNECTION_POSITION_TOLERANCE_VARIANTS: dict[str, type] = {
    "SET_VALUE": SetValuePositionTolerance,
    "OFF": OffPositionTolerance,
}

OneOf_MarcBondedAndTouchingContactConnectionPositionTolerance = Annotated[
    Union[SetValuePositionTolerance, OffPositionTolerance],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__MARC_BONDED_AND_TOUCHING_CONTACT_CONNECTION_POSITION_TOLERANCE_VARIANTS,
        )
    ),
]
