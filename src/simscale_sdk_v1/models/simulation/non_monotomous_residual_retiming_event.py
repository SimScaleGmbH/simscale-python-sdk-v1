...
class NonMonotomousResidualRetimingEvent(SimScaleModel):
    ...
    timestep_calculation_type: OneOf_NonMonotomousResidualRetimingEventTimestepCalculationType | None = Field(
