...
class SubdomainDimensionalInitialCondition_SpecificTurbulenceDissipationRate(SimScaleModel):
    name: str | None = Field(default=None)
    subdomain_value: Dimensional_SpecificTurbulenceDissipationRate | None = Field(
