...
_ONE_OF__SOLID_RESULT_CONTROL_VOLUME_CALCULATION_VARIANTS: dict[str, type] = {
...
OneOf_SolidResultControlVolumeCalculation = Annotated[
    Union[
        MinMaxFieldsCalculationResultControlItem,
        AverageFieldsCalculationResultControlItem,
        SumFieldsCalculationResultControlItem,
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__SOLID_RESULT_CONTROL_VOLUME_CALCULATION_VARIANTS,
        )
    ),
]
