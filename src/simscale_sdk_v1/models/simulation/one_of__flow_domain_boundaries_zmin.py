...
_ONE_OF__FLOW_DOMAIN_BOUNDARIES_ZMIN_VARIANTS: dict[str, type] = {
...
OneOf_FlowDomainBoundariesZMIN = Annotated[
    Union[VelocityInletBC, PressureOutletBC, WallBC, PeriodicBC, AtmosphericBoundaryLayerInletBC],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__FLOW_DOMAIN_BOUNDARIES_ZMIN_VARIANTS,
        )
    ),
]
