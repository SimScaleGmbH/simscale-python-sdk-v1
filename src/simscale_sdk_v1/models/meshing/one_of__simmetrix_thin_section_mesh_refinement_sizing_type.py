...
_ONE_OF__SIMMETRIX_THIN_SECTION_MESH_REFINEMENT_SIZING_TYPE_VARIANTS: dict[str, type] = {
    "SWEEP_MESHING_ABSOLUTE_SIZE": SweepMeshingAbsoluteSize,
    "SWEEP_MESHING_NUMBER_OF_ELEMENTS": SweepMeshingNumberOfElements,
}

OneOf_SimmetrixThinSectionMeshRefinementSizingType = Annotated[
    Union[SweepMeshingAbsoluteSize, SweepMeshingNumberOfElements],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SIMMETRIX_THIN_SECTION_MESH_REFINEMENT_SIZING_TYPE_VARIANTS,
        )
    ),
]
