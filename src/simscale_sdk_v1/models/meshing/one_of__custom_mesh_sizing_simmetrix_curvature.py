...
_ONE_OF__CUSTOM_MESH_SIZING_SIMMETRIX_CURVATURE_VARIANTS: dict[str, type] = {
    "AUTOMATIC_CURVATURE": AutomaticCurvature,
    "RELATIVE_CURVATURE": RelativeCurvature,
}

OneOf_CustomMeshSizingSimmetrixCurvature = Annotated[
    Union[AutomaticCurvature, RelativeCurvature],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__CUSTOM_MESH_SIZING_SIMMETRIX_CURVATURE_VARIANTS,
        )
    ),
]
