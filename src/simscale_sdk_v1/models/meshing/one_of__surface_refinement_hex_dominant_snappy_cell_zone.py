...
_ONE_OF__SURFACE_REFINEMENT_HEX_DOMINANT_SNAPPY_CELL_ZONE_VARIANTS: dict[str, type] = {
    "WITHOUT_CELL_ZONE": WithoutCellZone,
    "WITH_CELL_ZONE_V11": WithCellZone,
}

OneOf_SurfaceRefinementHexDominantSnappyCellZone = Annotated[
    Union[WithoutCellZone, WithCellZone],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SURFACE_REFINEMENT_HEX_DOMINANT_SNAPPY_CELL_ZONE_VARIANTS,
        )
    ),
]
