...
class SimmetrixSweptMeshRefinement(SimScaleModel):
    type_: str = Field(
    ...
    name: str | None = Field(default="Sweep meshing refinement")
    sizing_type: OneOf_SimmetrixSweptMeshRefinementSizingType | None = Field(
