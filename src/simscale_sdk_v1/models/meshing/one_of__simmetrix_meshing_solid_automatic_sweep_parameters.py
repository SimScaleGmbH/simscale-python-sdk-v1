...
_ONE_OF__SIMMETRIX_MESHING_SOLID_AUTOMATIC_SWEEP_PARAMETERS_VARIANTS: dict[str, type] = {
    "AUTOMATIC_SWEEP_MESHING_ON": AutomaticSweepOn,
    "AUTOMATIC_SWEEP_MESHING_OFF": AutomaticSweepOff,
}

OneOf_SimmetrixMeshingSolidAutomaticSweepParameters = Annotated[
    Union[AutomaticSweepOn, AutomaticSweepOff],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SIMMETRIX_MESHING_SOLID_AUTOMATIC_SWEEP_PARAMETERS_VARIANTS,
        )
    ),
]
