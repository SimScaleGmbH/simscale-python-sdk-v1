...
_ONE_OF__SURFACE_CUSTOM_SIZING_SIZING_VARIANTS: dict[str, type] = {
    "AUTOMATIC_V9": AutomaticMeshSizingSimmetrix,
    "CUSTOM": CustomMeshSizingSimmetrix,
}

OneOf_SurfaceCustomSizingSizing = Annotated[
    Union[AutomaticMeshSizingSimmetrix, CustomMeshSizingSimmetrix],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SURFACE_CUSTOM_SIZING_SIZING_VARIANTS,
        )
    ),
]
