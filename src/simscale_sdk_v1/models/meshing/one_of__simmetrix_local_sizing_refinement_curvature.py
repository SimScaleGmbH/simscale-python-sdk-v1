...
_ONE_OF__SIMMETRIX_LOCAL_SIZING_REFINEMENT_CURVATURE_VARIANTS: dict[str, type] = {
    "AUTOMATIC_CURVATURE": AutomaticCurvature,
    "RELATIVE_CURVATURE": RelativeCurvature,
}

OneOf_SimmetrixLocalSizingRefinementCurvature = Annotated[
    Union[AutomaticCurvature, RelativeCurvature],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SIMMETRIX_LOCAL_SIZING_REFINEMENT_CURVATURE_VARIANTS,
        )
    ),
]
