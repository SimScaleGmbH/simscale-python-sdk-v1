...
_ONE_OF__HEX_DOMINANT_SNAPPY_SIZING_VARIANTS: dict[str, type] = {
    "AUTOMATIC": AutomaticMeshSizingHexDominantSnappy,
    "MANUAL": ManualMeshSizingHexDominantSnappy,
}

OneOf_HexDominantSnappySizing = Annotated[
    Union[AutomaticMeshSizingHexDominantSnappy, ManualMeshSizingHexDominantSnappy],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__HEX_DOMINANT_SNAPPY_SIZING_VARIANTS,
        )
    ),
]
