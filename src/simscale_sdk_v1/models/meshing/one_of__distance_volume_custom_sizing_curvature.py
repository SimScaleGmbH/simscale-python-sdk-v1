...
_ONE_OF__DISTANCE_VOLUME_CUSTOM_SIZING_CURVATURE_VARIANTS: dict[str, type] = {
    "AUTOMATIC_CURVATURE": AutomaticCurvature,
    "RELATIVE_CURVATURE": RelativeCurvature,
}

OneOf_DistanceVolumeCustomSizingCurvature = Annotated[
    Union[AutomaticCurvature, RelativeCurvature],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__DISTANCE_VOLUME_CUSTOM_SIZING_CURVATURE_VARIANTS,
        )
    ),
]
