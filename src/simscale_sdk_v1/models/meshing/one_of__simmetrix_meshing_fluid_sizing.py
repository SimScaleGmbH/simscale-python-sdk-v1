...
_ONE_OF__SIMMETRIX_MESHING_FLUID_SIZING_VARIANTS: dict[str, type] = {
    "AUTOMATIC_V9": AutomaticMeshSizingSimmetrix,
    "MANUAL": ManualMeshSizingSimmetrix,
}

OneOf_SimmetrixMeshingFluidSizing = Annotated[
    Union[AutomaticMeshSizingSimmetrix, ManualMeshSizingSimmetrix],
    BeforeValidator(
        partial(
            parse_discriminated_union,
            disc_key="type",
            variants=_ONE_OF__SIMMETRIX_MESHING_FLUID_SIZING_VARIANTS,
        )
    ),
]
