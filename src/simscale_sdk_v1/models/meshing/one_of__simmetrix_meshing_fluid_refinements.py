...
_ONE_OF__SIMMETRIX_MESHING_FLUID_REFINEMENTS_VARIANTS: dict[str, type] = {
...
OneOf_SimmetrixMeshingFluidRefinements = Annotated[
    Union[
    ...
    BeforeValidator(
        partial(
            ...
            disc_key="type",
            variants=_ONE_OF__SIMMETRIX_MESHING_FLUID_REFINEMENTS_VARIANTS,
        )
    ),
]
