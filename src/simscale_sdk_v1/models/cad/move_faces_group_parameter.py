...
class MoveFacesGroupParameter(SimScaleModel):
    selected: Literal["move_faces_mode_distance", "move_faces_mode_to_entity"] = Field(
        description="Defines how the move distance is specified. It can be either: - `move_faces_mode_distance`, in which case the move distance will be provided, or - `move_faces_mode_to_entity`, in which case the move distance will be computed based on the provided face."
    )
