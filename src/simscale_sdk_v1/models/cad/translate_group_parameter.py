...
class TranslateGroupParameter(SimScaleModel):
    ...
    selected: Literal["translate_to_entity", "translate_vector"] = Field(
        description="Defines how the translation is specified. It can be either: - `translate_vector`, in which case the translation distance and direction will be provided, or - `translate_to_entity`, in which case the translation distance and direction will be computed based on the provided face."
    )
